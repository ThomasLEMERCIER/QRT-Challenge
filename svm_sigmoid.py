...
def parse_args():
    ...
    args_svm = argparse.Namespace(C=args.C, gamma=args.gamma, coef0=args.coef0)
...
if __name__ == "__main__":
    ...
    if args.wandb:
        wandb.init(project="QRT-Challenge-svm_sigmoid", entity="thomas_l")
    # =====================================
    ...
    if args.submit:
        ...
        save_predictions(predictions, "svm_sigmoid.csv")
    # ==========================
