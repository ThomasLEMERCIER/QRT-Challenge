...
def parse_args():
    ...
    args_svm = argparse.Namespace(C=args.C, gamma=args.gamma, degree=args.degree, coef0=args.coef0)
...
if __name__ == "__main__":
    ...
    if args.wandb:
        wandb.init(project="QRT-Challenge-svm_poly", entity="thomas_l")
    # =====================================
    ...
    C = args_svm.C
    kernel = "poly"
    degree = args_svm.degree
    gamma = args_svm.gamma
    coef0 = args_svm.coef0
    # ===============================
    ...
    if args.submit:
        ...
        save_predictions(predictions, "svm_poly.csv")
    # ==========================
